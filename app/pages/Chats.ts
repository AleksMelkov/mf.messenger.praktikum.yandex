...
import { ChatsApi, ChatNewMsgApi } from '../api/chatsApi';
...
export default class Chats extends Page {
    ...
    protected chatSettingBtnInit() {
      ...
      this.addingElement(
        ELEMENTS.CHAT_SETTING_BTN,
        Button,
        CONTROLLERS.CHAT_SETTING_BTN,
        chatSettingsButtonTmpl,
      );
    ...
    protected uploadAttachInit() {
      ...
      this.addingElement(
        ELEMENTS.UPLOAD_ATTACH,
        Button,
        CONTROLLERS.UPLOAD_ATTACH,
        uploadAttachTmpl,
      );
