...
export default class Page {
    ...
    public addingElement(
      name:string, element:asBlock<Block>,
      componentName:string, template:string,
    ):void|boolean {
      if (!this._elements) {
        this._elements = {};
      }
    ...
    // eslint-disable-next-line consistent-return
    public setSelectorElement(elementName:string, querySelector:string|HTMLElement):void|boolean {
    ...
    // eslint-disable-next-line consistent-return
    protected setAddTypeElement(elementName:string, type:string):void|boolean {
      if (!this.getElement(elementName)) {
        return false;
      }
    ...
    // eslint-disable-next-line consistent-return
    protected hideElement(elementName:string):void|boolean {
      if (!this.getElement(elementName)) {
        return false;
      }
    ...
    // eslint-disable-next-line consistent-return
    public removeElement(elementName:string):void|boolean {
      if (!this.getElement(elementName)) {
        return false;
      }
    ...
    // eslint-disable-next-line consistent-return
    public showElement(elementName:string):void|boolean {
    ...
    // eslint-disable-next-line consistent-return
    protected reRenderElement(elementName:string, props:Record<string, any>):void|boolean {
      const element = this.getElement(elementName);
      if (!element) {
        return false;
      }
